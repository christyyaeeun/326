...
//   updateOverlayVisibility, updateTodos, todos
// }) {
...
//       const todoId = uuid();
//       const todoInfo = { name, description, location, image: formState.image.name, id: todoId };
...
//       <Button title="Create New Todo" onClick={save} />
//       <Button type="cancel" title="Cancel" onClick={() => updateOverlayVisibility(false)} />
//       { formState.saving && <p className={savingMessageStyle}>Saving todo...</p> }
//     </div>
//   )
// }
